...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_retrieve_recipes(self):
        ...
        # many=True because we are serializing a list of recipes
    ...
    def test_filter_recipes_by_tags(self):
        ...
        tag_vegetarian = Tag.objects.create(user=self.user, name="Vegetarian")
        r1.tags.add(tag_vegan)
        r2.tags.add(tag_vegetarian)
        r3 = create_recipe(user=self.user, title="Fish and Chips")

        params = {"tags": f"{tag_vegan.id},{tag_vegetarian.id}"}
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image_to_other_user_recipe_error(self):
        """Test uploading an image to another user's recipe."""
        other_user = create_user(
            email="other@example.com",
            password="testpass123",
        )
        other_recipe = create_recipe(user=other_user)
        url = image_upload_url(other_recipe.id)
